...
public class TestMatrix
{
	public static void main (String[] args) 
    {
		...
		//case 1
		J = matrixProduct_DAC(A, B);
		System.out.println("Should throw exception");
		J = matrixProduct_Strassen(A, B);
		System.out.println("Should throw exception");
		
		
		//case 2
		J = matrixProduct_DAC(C, D);
		System.out.println("DAC Results:")
		printMatrix(J);
		System.out.println("DAC Answer:")
		printMatrix(M);
		J = matrixProduct_Strassen(C, D);
		...
		//case 3
		K = matrixProduct_DAC(E, F);
		System.out.println("DAC Results:")
		printMatrix(K);
		System.out.println("DAC Answer:")
		printMatrix(N);
		K = matrixProduct_Strassen(E, F);
		System.out.println("Strassen Results:")
		printMatrix(K);
		System.out.println("Strassen Answer:")
		printMatrix(N);
		...
		//case 4
		L = matrixProduct_DAC(G, H);
		System.out.println("DAC Results:")
		printMatrix(L);
		System.out.println("DAC Answer:")
		printMatrix(P);
		L = matrixProduct_Strassen(G, H);
		System.out.println("Strassen Results:")
		printMatrix(L);
		System.out.println("Strassen Answer:")
		printMatrix(P);
